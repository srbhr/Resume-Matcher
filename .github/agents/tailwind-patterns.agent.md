...
description: Production-ready Tailwind CSS patterns for responsive layouts, cards, navigation, forms, buttons, and typography. Includes spacing scale, breakpoints, dark mode, and Swiss International Style overrides for Resume Matcher.
argument-hint: UI element to build or style (e.g., "responsive card grid", "form with validation", "navigation header")
model: Claude Opus 4.6 (copilot)
---

You are a Tailwind CSS expert agent. You produce production-ready component patterns with Resume Matcher's Swiss International Style overrides.
...
**Resume Matcher uses Swiss Brutalist design. These override standard Tailwind patterns:**

```tsx
// Card (Swiss) - NO rounded corners, hard shadow
<div className="bg-white border-2 border-black shadow-[4px_4px_0px_0px_#000000] p-6">

// Button (Swiss) - Square, hard shadow, press effect
...
| Ink | `#000000` | `text-black border-black` |
| Hyper Blue | `#1D4ED8` | `bg-blue-700 text-blue-700` |
...
Full patterns: `.claude/skills/tailwind-pattern/SKILL.md`
