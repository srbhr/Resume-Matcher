...
export const ExperienceForm: React.FC<ExperienceFormProps> = ({ data, onChange }) => {
    ...
    const handleChange = (id: number, field: keyof Experience, value: any) => {
    ...
    return (
        <div className="space-y-6 border border-black p-6 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
            <div className="flex justify-between items-center border-b border-black pb-2 mb-4">
                <h3 className="font-serif text-xl font-bold">Work Experience</h3>
                    ...
                    <div key={item.id} className="p-6 border border-black bg-gray-50 relative group">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pr-8">
                            <div className="space-y-2">
                                <Label className="font-mono text-xs uppercase tracking-wider text-gray-500">Job Title</Label>
                                <Input
                                    value={item.title || ''}
                            ...
                            <div className="space-y-2">
                                <Label className="font-mono text-xs uppercase tracking-wider text-gray-500">Company</Label>
                                <Input
                                    value={item.company || ''}
                            ...
                            <div className="space-y-2">
                                <Label className="font-mono text-xs uppercase tracking-wider text-gray-500">Location</Label>
                                <Input
                                    value={item.location || ''}
