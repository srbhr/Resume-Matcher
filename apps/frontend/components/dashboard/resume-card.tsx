...
export const ResumeCard = ({ type, title, lastEdited, onClick }: ResumeCardProps) => {
    const baseClasses = "aspect-[3/4] w-full border-2 border-black transition-all duration-200 hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] cursor-pointer flex flex-col p-6 bg-white";
