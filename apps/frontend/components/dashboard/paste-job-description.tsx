      ...
      <div className="relative w-full max-w-2xl rounded-xl bg-gray-800 p-6 shadow-xl">
        ...
        <div className="py-6">
          <div className="flex flex-col items-center justify-center text-center mb-4">
            ...
            <p className="mb-2 text-lg font-semibold text-white">Paste Job Description</p>
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-gray-700">
          ...
          <Button onClick={handlePaste} className="bg-blue-600 hover:bg-blue-700 text-white">
