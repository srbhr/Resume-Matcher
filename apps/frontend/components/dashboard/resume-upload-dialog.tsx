...
import { UploadIcon, Loader2Icon, AlertCircleIcon, FileIcon, XIcon, CheckCircle2Icon } from 'lucide-react';
import { useFileUpload, formatBytes, FileMetadata } from '@/hooks/use-file-upload';
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="flex items-center gap-3 text-left overflow-hidden">
                                    ...
                                    <div className="min-w-0">
                                        <p className="font-bold text-sm truncate max-w-[200px]">{currentFile.file.name}</p>
                                        <p className="font-mono text-xs text-gray-500">{formatBytes(currentFile.file.size)}</p>
                                    </div>
                                </div>
                                <Button
                                    variant="ghost"
