...
const Glow = ({ delay }: { delay: number }) => {
  ...
  // Use state for random color to ensure consistency during hydration
  ...
  return (
    <motion.div
      ...
      className={`absolute left-1/2 -translate-x-1/2 z-10 h-[4px] w-[4px] rounded-full blur-[1px] shadow-2xl ${color}`}
    />
  );
};
