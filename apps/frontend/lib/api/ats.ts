...
export async function screenResume(request: ATSScreenRequest): Promise<ATSScreeningResult> {
...
export async function saveAtsResume(request: ATSSaveResumeRequest): Promise<ATSSaveResumeResponse> {
