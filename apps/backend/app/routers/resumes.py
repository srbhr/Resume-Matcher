...
MAGIC_BUFFER_SIZE = 2048  # Number of bytes to read for file type detection
...
async def get_file_type(response: Response) -> str | None:
    """
    ...
    try:
        ...
        file_data.seek(0)
        file_start_bytes = file_data.read(MAGIC_BUFFER_SIZE)
