...
- **Response (200 OK)**:
  ...
  _Note: `processed_resume` may be null if the resume hasn't been parsed/structured yet._
...
- **Response (200 OK)**:
  ...
  _Note: Returns an array of job_ids corresponding to the input array._
...
- **Response (200 OK)**:
  ...
  _Note: Scoring feature was removed in v1. Focus is on keyword alignment quality._
...
- **Request Body**:
  ```json
  {
    ...
    "model": "gpt-4o-mini",
    "api_key": "sk-...",
    "api_base": "http://ollama:11434 (optional, for Ollama)"
  }
  ```
  _Note: All fields are optional. Only provided fields are updated._
- **Response (200 OK)**:
  ```json
  {
    "provider": "openai",
